...
type ResultScreenProps = {
  party: Character[]
  onPartyUpdated: (party: Character[]) => void
...
export function ResultScreen({
  ...
  useEffect(() => {
    ...
    onPartyUpdated(updatedParty)
    saveGame({ party: updatedParty })
  }, [onPartyUpdated, updatedParty])
  ...
  return (
    <section className="result-screen">
      ...
      <button className="result-back-button" type="button" onClick={onBackToMainMenu}>
        メイン画面へ戻る
      </button>
    </section>
  )
